...
# ----------------------------------------
# karpenter-v1.2.1          1.2.1    # ref: https://github.com/aws/karpenter/releases/tag/v1.2.1 (recommend)
# karpenter-v1.1.3          1.1.3    # ref: https://github.com/aws/karpenter/releases/tag/v1.1.3
