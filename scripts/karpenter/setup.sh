...
# ----------------------------------------
# karpenter-v0.32.1        	0.32.1   # ref: https://github.com/aws/karpenter/releases/tag/v0.32.1 (recommend)
# karpenter-v0.32.0        	0.32.0   # ref: https://github.com/aws/karpenter/releases/tag/v0.32.0 # don't use
